        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    DLN = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    DLNExpDate = table.Column<DateOnly>(type: "date", nullable: false),
                    CreditCard = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    CreditCardExpDate = table.Column<DateOnly>(type: "date", nullable: false)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_TariffPermits_VehicleTypes_TypeId",
                        column: x => x.TypeId,
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_TariffTickets_VehicleTypes_TypeId",
                        column: x => x.TypeId,
                        principalTable: "VehicleTypes",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    TariffPermitId = table.Column<int>(type: "int", nullable: false),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Permit_TariffPermits_TariffPermitId",
                        column: x => x.TariffPermitId,
                        principalTable: "TariffPermits",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.NoAction);
                    table.ForeignKey(
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    VehicleId = table.Column<int>(type: "int", nullable: false),
                    ParkingSpaceId = table.Column<int>(type: "int", nullable: false),
                    TariffTicketId = table.Column<int>(type: "int", nullable: false),
                    Start = table.Column<DateTime>(type: "datetime2", nullable: false),
                    End = table.Column<DateTime>(type: "datetime2", nullable: false),
                    Value = table.Column<double>(type: "float", nullable: false)
                },
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.NoAction);
                    table.ForeignKey(
                        name: "FK_Ticket_TariffTickets_TariffTicketId",
                        column: x => x.TariffTicketId,
                        principalTable: "TariffTickets",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.NoAction);
                    table.ForeignKey(
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Permit_TariffPermitId",
                table: "Permit",
                column: "TariffPermitId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_TariffPermits_TypeId",
                table: "TariffPermits",
                column: "TypeId");

            migrationBuilder.CreateIndex(
                name: "IX_TariffTickets_TypeId",
                table: "TariffTickets",
                column: "TypeId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Ticket_TariffTicketId",
                table: "Ticket",
                column: "TariffTicketId");
